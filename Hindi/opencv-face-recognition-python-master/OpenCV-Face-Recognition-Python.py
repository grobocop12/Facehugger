...
subjects = ["", "Ramiz Raja", "Elvis Presley","Kamil Szkaradnik","Nicolas Cage","Jack Sparrow"]
...
#display both images
cv2.imshow("First", cv2.resize(predicted_img1, (400, 500)))
cv2.imshow("Second", cv2.resize(predicted_img2, (400, 500)))
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.waitKey(1)
cv2.destroyAllWindows()
